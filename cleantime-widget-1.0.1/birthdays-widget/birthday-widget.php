<?php
/*
    Plugin Name: Clean Time Anniversaries
    Plugin URI: https://wordpress.org/plugins/birthdays-widget/
    Description: Clean Time Anniversaries widget plugin produces a widget which displays a customizable happy NAnniversary image and wish to your clients/users.
    Author: lion2486, Sudavar
    Version: 2.0.0
    Author URI: https://californiastevewebdesign.com 
    Contributors: lion2486, Sudavar, California Steve
