<?php
    class Birthdays_Widget_Settings
    {
        ...
        public function add_plugin_page() {
            add_menu_page( 'Birthdays Widget', __( 'Clean Time Anniversaries', 'birthdays-widget' ), 'read', 'birthdays-widget', array( &$this, 'create_plugin_page' ) );
        ...
        <div class="wrap">
            ...
            <h2><?php _e( 'Clean Time Anniversaries Widget Options ', 'birthdays-widget' ); ?></h2>
            <?php
            ...
            <h2 class="nav-tab-wrapper">
                <a href="#birthdays-tab-general" class="nav-tab nav-tab-active">General Settings</a>
                <a href="#birthdays-tab-wp-user" class="nav-tab">WordPress User</a>
                <a href="#birthdays-tab-image" class="nav-tab">Image Settings</a>
                <a href="#birthdays-tab-access" class="nav-tab">Access</a>
                <a href="#birthdays-tab-calendar" class="nav-tab">Calendar</a>
                <a href="#birthdays-tab-upcoming" class="nav-tab">Upcoming</a>
            </h2>
            <form id="birthdays_settings_form" name="birthdays_form" method="post" action="">
                <div class="tab-content" id="birthdays-tab-general">
                ...
                <div class="tab-content" id="birthdays-tab-wp-user">
                    <table class="form-table">
                        <tbody>
                        <tr>
                ...
                <div class="tab-content" id="birthdays-tab-image">
                    <?php 
                ...
                <div class="tab-content" id="birthdays-tab-access">
    ...
    <?php foreach ( $supported_roles as $key => $role ) : ?>
        <input type="checkbox" name="roles[]" value="<?php echo $key; ?>" 
            <?php if ( is_array($current_roles) && in_array( $key, $current_roles ) ) echo 'checked="checked"'; ?> />
        <?php echo $role . '<br />';
    endforeach; ?>
    <input type="hidden" name="birthdays_save" value="1" />
                ...
                <div class="tab-content" id="birthdays-tab-calendar">
                    <table class="form-table">
                        <tbody>
                        <tr>
                ...
                <div class="tab-content" id="birthdays-tab-upcoming">
                    <table class="form-table">
                        <tbody>
                        <tr>
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <label for="upcoming_mode">
                                        ...
                                        <br /><span class="description">
                                            <?php _e( 'Ex: Consecutive days would be 1st February, 2nd February, 3rd February ... etc', 'birthdays-widget' ); ?><br />
                                            <?php _e( 'Days with birthdays could be 1st February, 3rd March, 15th March ... etc, based on the birthdays in your list', 'birthdays-widget' ); ?>
                                        </span>
                                    </label>
                                </fieldset>
                            </td>
        ...
        public function birthday_get_filtered_meta() {
            ...
            $tmp = array(); // Initialize $tmp as an empty array
            $table_name = $wpdb->prefix.'bp_xprofile_fields';
        
            if( $wpdb->get_var("SHOW TABLES LIKE '$table_name'") == $table_name ) {
                $select = $wpdb->prepare("SELECT %s.name, %s.id FROM %s", $table_name, $table_name, $table_name);
            ...
            $select = $wpdb->prepare("SELECT DISTINCT %s.meta_key FROM %s", $table_name, $table_name);
            $tmp = $wpdb->get_results( $select );
